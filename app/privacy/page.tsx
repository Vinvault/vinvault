      ...
      <div className="vv-page-container">
        ...
        <Section title="1. Data We Collect">
          ...
          <ul style={{ paddingLeft: '24px', marginBottom: '12px' }}>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Account data:</strong> email address and password (hashed) when you create an account.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Submission data:</strong> chassis records and associated vehicle details you submit to the registry, including your email address as submitter.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Usage data:</strong> pages visited, browser type, and approximate geographic location via IP address, collected anonymously for analytics.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Cookies:</strong> essential session cookies and optional analytics cookies (see Section 4).</li>
          </ul>
        ...
        <Section title="2. Legal Basis for Processing (GDPR)">
          ...
          <ul style={{ paddingLeft: '24px' }}>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Contract performance:</strong> to provide your account, manage your submissions, and operate the registry.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Legitimate interests:</strong> to prevent fraud, improve the service, and maintain the integrity of registry records.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Consent:</strong> for optional analytics cookies and newsletter communications.</li>
          </ul>
        </Section>
        ...
        <Section title="4. Cookies">
          ...
          <ul style={{ paddingLeft: '24px' }}>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Essential cookies:</strong> session authentication cookies required for logged-in functionality. These cannot be disabled without breaking the site.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Analytics cookies:</strong> optional cookies that help us understand how visitors use the site. You can decline these via our cookie consent banner.</li>
          </ul>
        ...
        <Section title="6. Your Rights (GDPR)">
          ...
          <ul style={{ paddingLeft: '24px' }}>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Access:</strong> request a copy of the personal data we hold about you.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Rectification:</strong> request correction of inaccurate data.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Erasure:</strong> request deletion of your account and personal data.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Restriction:</strong> request that we limit processing of your data.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Portability:</strong> receive your data in a structured, machine-readable format.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Objection:</strong> object to processing based on legitimate interests.</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Withdraw consent:</strong> withdraw consent for analytics cookies at any time.</li>
          </ul>
        ...
        <Section title="7. Data Sharing">
          ...
          <ul style={{ paddingLeft: '24px' }}>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Supabase</strong> (database hosting, EU region).</li>
            <li style={{ marginBottom: '8px' }}><strong style={{ color: colors.textPrimary }}>Brevo</strong> (transactional email delivery).</li>
        ...
        <Section title="9. Contact & Data Controller">
          <p>VinVault is the data controller for personal data processed through this site. For privacy enquiries, data subject requests, or complaints, contact us via the <Link href="/faq" style={{ color: colors.accentBlue, textDecoration: 'none' }}>FAQ page</Link>. You also have the right to lodge a complaint with your national data protection authority.</p>
        </Section>
      </div>
    </main>
  );
