  ...
  return (
    <main style={{ background: "#080F1A", color: "#E2EEF7", fontFamily: "Georgia, serif", minHeight: "100vh" }}>
      ...
      <div className="vv-page-container">
        ...
        <p style={{ color: "#4A6A8A", fontSize: "13px", marginBottom: "48px" }}>Last updated: 3 May 2026</p>
        ...
        <Section title="7. Contact">
          <p>For questions about these Terms, please contact us via the <Link href="/faq" style={{ color: "#4A90B8", textDecoration: "none" }}>FAQ page</Link> or by submitting an inquiry through the registry.</p>
        </Section>
      </div>
