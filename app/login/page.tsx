      ...
      <div style={{flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px 20px'}}>
        <div style={{width: '100%', maxWidth: '440px'}}>
          ...
          <p style={{color: '#8BA5B8', fontSize: '14px', marginBottom: '32px'}}>
            {mode === 'login'
              ? 'Sign in to your VinVault account'
              : 'Create an account to contribute to the registry'}
          </p>
          ...
          <form onSubmit={mode === 'login' ? handleLogin : handleRegister}>
            ...
            <button
              ...
              style={{
                width: '100%',
                background: loading ? '#2A4A6A' : '#4A90B8',
                color: '#fff',
                padding: '14px',
                fontSize: '13px',
                letterSpacing: '2px',
          ...
          {mode === 'login' && (
            <p style={{textAlign: 'center', marginTop: '24px', color: '#4A6A8A', fontSize: '13px'}}>
              No account?{' '}
              <button onClick={() => setMode('register')} style={{background: 'none', border: 'none', color: '#4A90B8', cursor: 'pointer', fontFamily: 'Georgia, serif', fontSize: '13px'}}>
                Register here
              </button>
            </p>
          )}
